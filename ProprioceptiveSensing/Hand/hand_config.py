...
PC1_THUMB  = np.deg2rad([70.0, 0.0, 95.0, 95.0])
PC1_SPREAD = {
...
PC1_INDEX  = np.deg2rad([55.0, 75.0, 75.0])
PC1_MIDDLE = np.deg2rad([55.0, 75.0, 75.0])
PC1_RING   = np.deg2rad([55.0, 75.0, 75.0])
PC1_PINKY  = np.deg2rad([55.0, 75.0, 75.0])

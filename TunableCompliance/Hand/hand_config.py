...
UR5_POSE_INHAND = np.array([-0.09, 0.71, 0.31, -0.71, 1.10, 2.53])

# dynamic_grasp.py — hand open, aligned with the bottle; UR5 slides along +X.
UR5_POSE_BOTTLE_START = np.array([0, 0.66, 0.29, 0.0, 0.0, -1.96])
...
K_ROT_FLEX  = 0.05      # [N·m/rad]    flex joint stiffness when task spring is active

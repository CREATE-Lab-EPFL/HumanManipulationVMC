...
INHAND_PC1_THUMB  = np.deg2rad([60.0, -80.0, 80.0, 80.0])
INHAND_PC1_SPREAD = {
...
INHAND_PC1_INDEX  = np.deg2rad([60.0, 80.0, 80.0])
INHAND_PC1_MIDDLE = np.deg2rad([60.0, 80.0, 80.0])
INHAND_PC1_RING   = np.deg2rad([60.0, 80.0, 80.0])
INHAND_PC1_PINKY  = np.deg2rad([60.0, 80.0, 80.0])

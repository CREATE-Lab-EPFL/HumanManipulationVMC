...
# k_applied = clip(K_SCALE * δ_mean, K_MIN, K_MAX), with δ_mean in metres.
# Calibrate K_SCALE so that δ from a soft and a hard object spans [K_MIN, K_MAX].
K_TIP_GENTLE = 10.0     # [N/m]   sensing stiffness during δ measurement
K_SCALE      = 3000.0   # [N/m²]  slope of the δ → k_applied map
